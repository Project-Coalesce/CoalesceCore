...
public abstract class AbstractSession<T> implements ISession<T> {
    ...
    private final NamespacedSessionStore<ISession> namespace;
    private final Class<? extends ISession> session;

    public AbstractSession(ICoPlugin sessionOwner, NamespacedSessionStore<ISession> namespace, String sessionKey, T type) {
        this.type = type;
