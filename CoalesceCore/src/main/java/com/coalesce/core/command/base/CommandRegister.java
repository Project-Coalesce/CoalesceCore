...
public abstract class CommandRegister<C extends CommandContext, T extends TabContext> extends Command implements PluginIdentifiableCommand {
    
    protected final ICoPlugin plugin;
    protected final ProcessedCommand<C, T> command;
    
    public CommandRegister(ProcessedCommand<C, T> command, ICoPlugin plugin) {
